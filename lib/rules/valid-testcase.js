...
module.exports = {
	meta: {
		...
		messages: {
			...
			missingSuggestion: "Error must specify 'suggestions'.",
			extraSuggestion:
			...
			missingMessage: "Test case must specify either 'messageId' or 'message'.",
			...
			extraMessageId: "Error should not specify both 'message' and a 'messageId'.",
			extraData: "Error should not specify both 'data' and 'message'."
		},
		schema: [],
		type: 'suggestion'
	},
