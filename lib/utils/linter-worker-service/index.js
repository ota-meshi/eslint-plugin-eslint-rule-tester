...
/** @type {Record<string, WorkerService|undefined>}  */
...
function getLinterService(ruleName, rulePath) {
	...
	const workerService = workerServices[key] || (workerServices[key] = buildWorkerService({ isTs }));
	return {
 ...
 */
function buildWorkerService({ isTs }) {
	let seq = 0;
